                      ...
                      <div className="flex items-center justify-between">
                        {STATUS_STEPS.map((step, index) => {
                          ...
                          return (
                            ...
                            >
                              <div
                                className={`h-10 w-10 rounded-full flex items-center justify-center border-2 ${isActive
                              ...
                              <p
                                className={`text-xs mt-2 ${isActive ? "text-gray-800" : "text-gray-400"
                                  }`}
                              >
                                {step.label}
                              </p>
                              {index < STATUS_STEPS.length - 1 && (
                                <div
                                  className={`h-0.5 w-full -mt-5 ${index < activeStepIndex
                                    ? "bg-green-500"
                                    : "bg-gray-200"
                                    }`}
                                />
