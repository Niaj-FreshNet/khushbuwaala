...
export default function EnhancedShopPage() {
  ...
  return (
    <>
      ...
      <div className="w-full mx-auto min-h-screen bg-gradient-to-b from-white to-gray-50/30">
        {/* Enhanced Shop Banner */}
        <ShopBanner
          heading="Premium Perfume Oil Collection"
          text="Discover our curated selection of world-class perfume oils, crafted with authentic ingredients and unmatched quality"
          ...
          altText="KhushbuWaala Premium Perfume Oil Collection Banner"
          variant="premium"
        />
