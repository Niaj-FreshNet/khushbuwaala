...
// ✅ Import client wrapper for Related Products
...
// const ProductPageBottomBar = dynamic(
//     () => import("@/components/Modules/Product/ProductPageBottomBar"),
//     { ssr: false }
// );
...
const getCategoryInfo = (category: string) => {
    const categoryMap: Record<string, { name: string; href: string }> = {
        ...
        naturalCollection: {
            ...
            href: "/natural-collection",
        },
        orientalCollection: {
            name: "Oriental Collection",
            href: "/oriental-collection",
        },
        forWomen: { name: "For Women", href: "/for-women" },
        giftsAndPackages: {
            name: "Gifts & Packages",
