...
export function ProductCard({ 
    ...
    return (
      ...
      >
        <div className="flex flex-row">
          <div className="relative aspect-[4/5] w-72 flex-shrink-0 overflow-hidden bg-gray-100">
  ...
  return (
    <Card
      className={cn(
        "overflow-hidden rounded-2xl !pb-4 bg-white border border-gray-100 shadow-sm hover:shadow-2xl transition-shadow duration-300 group",
        className
      )}
    >
