...
export function ShopBanner({ 
  ...
  return (
    <section
      className="relative w-full h-[250px] md:h-[360px] overflow-hidden group"
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8">
        ...
        <h1
          ...
          className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight leading-tight drop-shadow-2xl mb-6 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200"
        >
